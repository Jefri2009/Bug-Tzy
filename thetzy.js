...
🔥 KALAU MAU RENAME TARO CREDITS GUA : 4K */
const fs = require('fs')
...
global.youtube = 'https://www.youtube.com/@4KSanzz'
global.ig = 'https://instagram.com/fhl.dx17'
global.mygc = '-'
global.myweb = '-'
global.linkgrupss = "-"
...
//—————「 Set Nama Own & Bot 」—————//
global.nomerOwner = "6281236167286" //Bebas ganti 
global.namaOwner = "𝙼 Sanzz" //Bebas ganti
global.footer = '𝙼 Sanzz' //ubah jadi nama mu, note tanda ' gausah di hapus!
//=================================================//
global.packname = '© 4k'
global.ownerr = ['San']
global.author = '[⫹⫺ - Sanzz]'
